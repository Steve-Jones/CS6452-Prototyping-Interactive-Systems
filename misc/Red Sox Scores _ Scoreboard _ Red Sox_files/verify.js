    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'c1c04b8dbd9c47eab3b2484899902b8c',
                comparisonItems:[{name : 'cmp', value : 10986138},{name : 'plmt', value : 10986168}]
            }
        };
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_450677667301');
                if (frame) {
...
}, 10);var impId = 'c1c04b8dbd9c47eab3b2484899902b8c';var dvObj = $dvbs;var rtnName = dvObj==window.$dv ? 'ImpressionServed' : 'BeforeDecisionRender';dvObj.pubSub.subscribe(rtnName, impId, 'HE_RTN', function () { try {var ifu = '';var alu = 'http://ad.doubleclick.net/ddm/clk/291583327;106680815;k';var lbl='';var d=null,e=dvObj==window.$dv?parent:window,h=0,i=0,k=[],l=[],m=10;
...
});var dvObj=$dvbs;var impId='c1c04b8dbd9c47eab3b2484899902b8c';dvObj.pubSub.subscribe('ImpressionServed',impId,'AttributeCollection',function(){
...
try{__tagObject_callback_450677667301({ImpressionID:"c1c04b8dbd9c47eab3b2484899902b8c", ServerPublicDns:"tps602.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "c1c04b8dbd9c47eab3b2484899902b8c");}catch(e){}
try{__verify_callback_450677667301({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "c1c04b8dbd9c47eab3b2484899902b8c");}catch(e){}
