    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'1e155e415d9a441eaa06baae70e13342',
                comparisonItems:[{name : 'cmp', value : 10986138},{name : 'plmt', value : 10986316}]
            }
        };
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_341641844424');
                if (frame) {
...
}, 10);var impId = '1e155e415d9a441eaa06baae70e13342';var dvObj = $dvbs;var rtnName = dvObj==window.$dv ? 'ImpressionServed' : 'BeforeDecisionRender';dvObj.pubSub.subscribe(rtnName, impId, 'HE_RTN', function () { try {var ifu = '';var alu = 'http://ad.doubleclick.net/ddm/clk/291583327;106680815;k';var lbl='';var d=null,e=dvObj==window.$dv?parent:window,h=0,i=0,k=[],l=[],m=10;
...
});var dvObj=$dvbs;var impId='1e155e415d9a441eaa06baae70e13342';dvObj.pubSub.subscribe('ImpressionServed',impId,'AttributeCollection',function(){
try{try{(function(){var e=window;var t=0;try{while(e.parent&&e!=e.parent&&e.parent.document){e=e.parent;if(t++>10)break}}catch(r){}var n=0;function a(e,t){if(t)n=(n|1<<e)>>>0}if(!document.querySelectorAll){document.querySelectorAll=function(e){var t=document.createElement("style"),r=[],n;document.documentElement.firstChild.appendChild(t);document._qsa=[];t.styleSheet.cssText=e+"{x-qsa:expression(document._qsa && document._qsa.push(this))}";window.scrollBy(0,0);t.parentNode.removeChild(t);while(document._qsa.length){n=document._qsa.shift();n.style.removeAttribute("x-qsa");r.push(n)}document._qsa=null;return r}}function d(t){var r=e.document;if(!r.querySelector){var n=r.createElement("style"),c=[],a;r.documentElement.firstChild.appendChild(n);r._qsa=[];n.styleSheet.cssText=selectors+"{x-qsa:expression(document._qsa && document._qsa.push(this))}";window.scrollBy(0,0);n.parentNode.removeChild(n);while(r._qsa.length){a=r._qsa.shift();a.style.removeAttribute("x-qsa");c.push(a)}r._qsa=null;return c.length?c[0]:null}return r.querySelector(t)}a(0,true);a(1,e.xy_checksum&&e.place_player&&e.logjwonready&&e.logContentPauseRequested);a(2,e.playerInstance&&d('script[src*="ads-player.com"]'));a(3,d('script[src*="roimediaconsultants.com"]'));a(4,e.zpz&&e.zpz.createPlayer);a(5,d('script[src*="efreader.com"]')||d('script[src*="egreader.com"]'));a(6,e.document.head.children&&e.document.head.children.length==3&&e.jwplayer&&!e.document.title);a(7,c=d('script[src*="try {jwplayer().play()} catch(e){}"]'),c!=null&&c.textContent&&c.textContent.indexOf('var els=w.document.getElementsByTagName("embed");')>-1);a(8,e.loadScript&&e.myppp2&&e.document.forms&&e.document.forms["redirect1"]);a(9,e.outerHeight==480&&e.innerHeight==395);a(10,e.outerHeight==395&&e.innerHeight==480);dvObj.registerEventCall(impId,{dvp_acv:n,dvp_acc:e==e.top&&e.document.head&&e.document.head.children?e.document.head.children.length:-1,dvp_acl:e==e.top&&e.document.head&&e.document.head.outerHTML?e.document.head.outerHTML.length:-1})})()}catch(e){dvObj.registerEventCall(impId,{dvp_ace:String(e).substring(0,150)})}}catch(e){}
});


try{__tagObject_callback_341641844424({ImpressionID:"1e155e415d9a441eaa06baae70e13342", ServerPublicDns:"tps620.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "1e155e415d9a441eaa06baae70e13342");}catch(e){}
try{__verify_callback_341641844424({
ResultID:2,
Passback:"",
AdWidth:728,
AdHeight:90});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "1e155e415d9a441eaa06baae70e13342");}catch(e){}
